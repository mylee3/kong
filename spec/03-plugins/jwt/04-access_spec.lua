...
describe("JWT access", function()
  ...
  local api1, api2, api3, api4, api5
  local consumer1, consumer2, consumer3, consumer4
  ...
  setup(function()
    ...
    consumer4 = assert(helpers.dao.consumers:insert {username = "jwt_tests_rsa_consumer_2"})
  ...
  describe("refusals", function()
    ...
    it("should return 401 if the claims do not contain the key to identify a secret", function()
